/**
 * Route tests for the Settings app top-level routes.
...
describe('Settings appRoutes', () => {
  ...
  describe('router integration', () => {
    ...
    // Provide resolved routes directly so we can navigate without real lazy loading
